...
const storage = new Storage({
    projectId: "delivery-app-udemy-a5498",  //Firebase --Configuracion del proyecto--Id del proyecto
    keyFilename: './serviceAccountKey.json' //Firebase --Configuracion del proyecto-- Cuentas de servicio descargamos el archivo y lo pegamos a nivel de proyecto
});

const bucket = storage.bucket("gs://delivery-app-udemy-a5498.appspot.com/"); //Firebase --Storage    
